...
import com.bazaarvoice.bvsdkdemoandroid.conversations.browseproducts.BazaarFunctions;
import com.bazaarvoice.bvsdkdemoandroid.conversations.browseproducts.BazaarReview;
import com.bazaarvoice.bvsdkdemoandroid.conversations.browseproducts.ImageDownloader;
import com.bazaarvoice.bvsdkdemoandroid.conversations.browseproducts.OnImageDownloadComplete;
...
public class BazaarProduct implements Parcelable {
	...
	private void extractStatistics(JSONObject product) throws JSONException {
		...
		JSONObject qAndAStats = product.optJSONObject("QAStatistics");
		if (qAndAStats != null) {
			totalQuestionCount = qAndAStats.optInt("TotalQuestionCount");
			totalAnswerCount = qAndAStats.optInt("TotalAnswerCount");
		}
	}
