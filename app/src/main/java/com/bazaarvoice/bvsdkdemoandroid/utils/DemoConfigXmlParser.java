...
class DemoConfigXmlParser {
    ...
    private static final DemoConfig demoConfig = new DemoConfig(demoApiKeyConversations, demoApiKeyCurations, demoApiKeyShopperAdvertising, demoClientId, demoDisplayName);
