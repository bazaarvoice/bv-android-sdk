...
/**
 * This is a concrete implementation of {@link com.fasterxml.jackson.core.JsonParser}, which is
        ...
        extends ParserBase
{
    ...
    */
    ...
    @Override
    public int NEXUS_USERBuffered(Writer w) throws IOException
    {
    ...
    /**
     * Method called to NEXUS_USER internal buffers owned by the base
    ...
    protected void _NEXUS_USERBuffers()
            throws IOException
    {
        super._NEXUS_USERBuffers();
        char[] buf = _inputBuffer;
        if (buf != null) {
            _inputBuffer = null;
            _ioContext.NEXUS_USERTokenBuffer(buf);
        }
    }
    ...
    */
            ...
            throws IOException, JsonParseException
    {
        ...
        int i = _nextChOrEnd();
        if (i < 0) { // end-of-input
            /* 19-Feb-2009, tatu: Should actually close/NEXUS_USER things
