...
public class SubmissionParams extends BazaarParams {
	...
	// hosted auth
	private String hostedAuthEmail;
	private String hostedAuthCallbackUrl;
    ...
    public String getHostedAuthEmail(){ return hostedAuthEmail;}

    /**
     *  @param hostedAuthEmail
     *  This parameter tells the Bazaarvoice platform where to send the email that will contain the authentication link.
     *  HostedAuthentication_AuthenticationEmail overrides anything submitted in the 'useremail' field.
     *  For further info, please refer to: https://developer.bazaarvoice.com/apis/conversations/tutorials/bazaarvoice_mastered_authentication
     */
    public void setHostedAuthEmail(String hostedAuthEmail){this.hostedAuthEmail = hostedAuthEmail;}

    public String getHostedAuthCallbackUrl(){return hostedAuthCallbackUrl;}

    /**
     * @param hostedAuthCallbackUrl
     *  This URL will be used as the front-end to your authentication service.
     *  The HostedAuthentication_CallbackURL does not appear in the API response as an available field because it does not represent a user facing question.
     *  You should submit this value with no input from content authors. This URL must be white-listed.
     *  For further info, please refer to: https://developer.bazaarvoice.com/apis/conversations/tutorials/bazaarvoice_mastered_authentication
     */
    public void setHostedAuthCallbackUrl(String hostedAuthCallbackUrl){ this.hostedAuthCallbackUrl = hostedAuthCallbackUrl; }

    public String getUserAuthString(){ return userAuthString; }

    /**
     * @param userAuthString
     *  When using Hosted Authentication to confirm posts with the Conversations API,
     *  use the Bazaarvoice-provided User Authentication String to tie the deivce to the user ID so the user can make authenticated POSTs.
     *  For further info, please refer to: https://developer.bazaarvoice.com/apis/conversations/tutorials/bazaarvoice_mastered_authentication

     */
    public void setUserAuthString( String userAuthString){ this.userAuthString = userAuthString; }
...
StringBuilder url = new StringBuilder();
        ...
        url.append(addURLParameter("HostedAuthentication_AuthenticationEmail", this.hostedAuthEmail));
        url.append(addURLParameter("HostedAuthentication_CallbackURL", this.hostedAuthCallbackUrl));
        url.append(addURLParameter("User", this.userAuthString));
