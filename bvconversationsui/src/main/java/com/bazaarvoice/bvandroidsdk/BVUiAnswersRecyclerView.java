 ...
 * many {@link BVUiAnswerView}s providing usage Analytic events.
 */
public final class BVUiAnswersRecyclerView extends BVRecyclerView {

    private String productId = "";

    public BVUiAnswersRecyclerView(Context context) {
        super(context);
    }

    public BVUiAnswersRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public BVUiAnswersRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
